...
class _ReorderableWrapState extends State<ReorderableWrap> {
  ...
  Widget build(BuildContext context) {
    final PassthroughOverlay passthroughOverlay =
        PassthroughOverlay(key: _overlayKey, initialEntries: <PassthroughOverlayEntry>[
      _listOverlayEntry,
    ]);
...
//        }
        ...
        if (_wrapKey.currentContext != null) {
          RenderWrapWithMainAxisCount wrapRenderObject =
              _wrapKey.currentContext!.findRenderObject() as RenderWrapWithMainAxisCount;
      ...
      if (!isReorderable) {
        ...
        child = this.widget.needsLongPressDraggable
            ? LongPressDraggable<int>(
                maxSimultaneousDrags: widget.enableDragging ? 1 : 0,
                data: index,
                //toWrap.key,
